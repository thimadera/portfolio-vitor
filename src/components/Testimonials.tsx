...
export function Testimonials({
  ...
  return (
    <section
      id="avaliações"
      className="py-12 md:py-20 px-4 bg-brand-orange relative overflow-hidden"
    >
      ...
      <div className="max-w-360 mx-auto relative z-10 px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          <div className="lg:col-span-12 xl:col-span-5 flex flex-col gap-6 md:gap-12">
          ...
          <div className="lg:col-span-12 xl:col-span-7">
            <div className="relative min-h-100 md:min-h-125 grid items-center">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="grid grid-cols-[auto_1fr] items-center gap-6">
                    <div className="w-16 h-16 rounded-full bg-white/10 grid place-items-center text-white font-bold text-xl">
