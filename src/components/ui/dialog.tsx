        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-4 right-4 z-20 w-10 h-10 rounded-full bg-brand-dark/10 hover:bg-brand-dark/20"
                size="icon"
              />
            }
          >
